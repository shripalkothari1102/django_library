...
urlpatterns = [
    ...
    path('publisher_multiple_create/', views.ParentCreateView.as_view(), name='publisher_multiple_create'),
    path('publisher_multiple_update/<int:pk>', views.ParentUpdateView.as_view(), name='publisher_multiple_update'),
]